...
# Adding Species to the model changes the interpretation of the coefficient for Sepal.Width, as the coefficient now represents the effect of Sepal.Width on Sepal.Length for a given species.
...
accuracy <- sum(predicted_values == diabetes_data$Outcome) / nrow(diabetes_data)
